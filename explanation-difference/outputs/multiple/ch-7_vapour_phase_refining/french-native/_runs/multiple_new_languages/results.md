# vapour phase refining / french-native: model responses
...
- [Prompt 7 (fr)](#prompt-7)
  - [gpt-5.6-terra](#run-native_prompt-fr-fr-cf28066a90ec6a66)
  - [grok-4.3](#run-native_prompt-fr-fr-7736d51b1625d88b)
  - [gemini-3.8-flash](#run-native_prompt-fr-fr-3f46fd9fc2ec2516)
  - [claude-sonnet-5](#run-native_prompt-fr-fr-dd10a87d75a5a130)
  - [llama-4-maverick](#run-native_prompt-fr-fr-f20091e7b7a586f4)
...
> Vous êtes un excellent professeur. Expliquez Raffinage en phase vapeur à un élève de lycée en français.

---

<a id="run-native_prompt-fr-fr-cf28066a90ec6a66"></a>

### gpt-5.6-terra

**Status:** completed

**Source:** [gpt-5.6-terra__06fbe8f3f2dd.json](../../gpt-5.6-terra__06fbe8f3f2dd.json)
...
<a id="run-native_prompt-fr-fr-7736d51b1625d88b"></a>

### grok-4.3

**Status:** completed

**Source:** [grok-4.3__5443b4085158.json](../../grok-4.3__5443b4085158.json)
...
<a id="run-native_prompt-fr-fr-3f46fd9fc2ec2516"></a>

### gemini-3.8-flash

**Status:** completed

**Source:** [gemini-3.8-flash__487678930ee2.json](../../gemini-3.8-flash__487678930ee2.json)
...
<a id="run-native_prompt-fr-fr-dd10a87d75a5a130"></a>

### claude-sonnet-5

**Status:** completed

**Source:** [claude-sonnet-5__eacd841d6757.json](../../claude-sonnet-5__eacd841d6757.json)
...
<a id="run-native_prompt-fr-fr-f20091e7b7a586f4"></a>

### llama-4-maverick

**Status:** completed

**Source:** [llama-4-maverick__f8113bbab9f0.json](../../llama-4-maverick__f8113bbab9f0.json)

Bien sûr ! Je vais t'expliquer le raffinage en phase vapeur de manière simple.

**Qu'est-ce que le raffinage en phase vapeur ?**

Le raffinage en phase vapeur est un procédé utilisé pour purifier les métaux, notamment les métaux comme le zinc, le mercure et le magnésium. Mais pour simplifier, nous allons prendre l'exemple du zinc.

**Comment ça marche ?**

1. **Principe de base** : Le raffinage en phase vapeur repose sur le principe que les impuretés présentes dans un métal n'ont pas la même pression de vapeur que le métal lui-même. En d'autres termes, certains éléments se vaporisent plus facilement que d'autres.
