...
- [Prompt 1 (en)](#prompt-1)
  - [gpt-5.6-terra](#run-001-001-6908cb327e8a)
  - [grok-4.3](#run-001-002-833a5715c193)
  - [gemini-3.8-flash](#run-001-003-d6d6cafcb2ac)
  - [claude-sonnet-5](#run-001-004-0ada98e92494)
  - [llama-4-maverick](#run-001-005-6f56fea9d434)
- [Prompt 2 (ta)](#prompt-2)
  - [gpt-5.6-terra](#run-002-001-33b5ee5ed1a4)
  - [grok-4.3](#run-002-002-4b496d7869cc)
  - [gemini-3.8-flash](#run-002-003-f6439913b2c1)
  - [claude-sonnet-5](#run-002-004-66fb522af174)
  - [llama-4-maverick](#run-002-005-e57775f9bc3f)
- [Prompt 3 (ta)](#prompt-3)
  - [gpt-5.6-terra](#run-003-001-ac3b2af7c62a)
  - [grok-4.3](#run-003-002-a0a89211ab2b)
  - [gemini-3.8-flash](#run-003-003-e9c199347fd8)
  - [claude-sonnet-5](#run-003-004-fdbe6dbf2911)
  - [llama-4-maverick](#run-003-005-405efe7dd2b8)
...
> You are an expert teacher teaching an high school student. Explain isotope in English.

---

<a id="run-001-001-6908cb327e8a"></a>
...
Some isotopes are **stable**, meaning they do not change over time. Others are **radioactive**, meaning they slowly break down and release radiation. For example, carbon-14 is radioactive and is used to estimate the age of ancient bones, wood, and fossils.


---

<a id="run-001-002-833a5715c193"></a>
...
<a id="run-001-003-d6d6cafcb2ac"></a>
...
<a id="run-001-004-0ada98e92494"></a>
...
<a id="run-001-005-6f56fea9d434"></a>
...
Isotopes are atoms of the same chemical element that have the same number of protons in their atomic nuclei (that's what makes them the same element), but differ in the number of neutrons. Yeah, it sounds a bit complicated, so let's break it down.
...
> நீங்கள் ஒரு சிறந்த ஆசிரியர். ஒரு உயர்நிலைப் பள்ளி மாணவருக்கு ஓரிடத்தான் பற்றி விளக்குங்கள்.

---

<a id="run-002-001-33b5ee5ed1a4"></a>
...
<a id="run-002-002-4b496d7869cc"></a>
...
<a id="run-002-003-f6439913b2c1"></a>
...
<a id="run-002-004-66fb522af174"></a>
...
<a id="run-002-005-e57775f9bc3f"></a>
...
> You are an expert teacher teaching an high school student. Explain isotopes in Tamil.

---

<a id="run-003-001-ac3b2af7c62a"></a>
...
<a id="run-003-002-a0a89211ab2b"></a>
...
<a id="run-003-003-e9c199347fd8"></a>
...
<a id="run-003-004-fdbe6dbf2911"></a>
...
<a id="run-003-005-405efe7dd2b8"></a>
