...
- [Prompt 1 (en)](#prompt-1)
  - [gpt-5.6-terra](#run-001-001-bfad9c0f98a5)
  - [grok-4.3](#run-001-002-02324cd4a644)
  - [gemini-3.8-flash](#run-001-003-44e9577041b0)
  - [claude-sonnet-5](#run-001-004-1671f807028b)
  - [llama-4-maverick](#run-001-005-a0c390bda440)
- [Prompt 2 (ta)](#prompt-2)
  - [gpt-5.6-terra](#run-002-001-bee6bb6ef255)
  - [grok-4.3](#run-002-002-b4720c172353)
  - [gemini-3.8-flash](#run-002-003-a77895c09229)
  - [claude-sonnet-5](#run-002-004-9060bf1ad204)
  - [llama-4-maverick](#run-002-005-ea5a62a22df8)
- [Prompt 3 (ta)](#prompt-3)
  - [gpt-5.6-terra](#run-003-001-a3af3a3a3477)
  - [grok-4.3](#run-003-002-924bd122bd32)
  - [gemini-3.8-flash](#run-003-003-4fa00ddeda1a)
  - [claude-sonnet-5](#run-003-004-cbee6fc9b855)
  - [llama-4-maverick](#run-003-005-3f40934b7a5f)
...
> You are an expert teacher teaching an high school student. Explain mole concept in English.

---

<a id="run-001-001-bfad9c0f98a5"></a>
...
<a id="run-001-002-02324cd4a644"></a>
...
<a id="run-001-003-44e9577041b0"></a>
...
As your teacher, I’m going to let you in on a secret: **A mole is just a counting word.** 
...
<a id="run-001-004-1671f807028b"></a>
...
<a id="run-001-005-a0c390bda440"></a>
...
> நீங்கள் ஒரு சிறந்த ஆசிரியர். ஒரு உயர்நிலைப் பள்ளி மாணவருக்கு மோல் பற்றிய கோட்பாடு பற்றி விளக்குங்கள்.

---

<a id="run-002-001-bee6bb6ef255"></a>
...
<a id="run-002-002-b4720c172353"></a>
...
<a id="run-002-003-a77895c09229"></a>
...
<a id="run-002-004-9060bf1ad204"></a>
...
<a id="run-002-005-ea5a62a22df8"></a>
...
> You are an expert teacher teaching an high school student. Explain mole concept in Tamil.

---

<a id="run-003-001-a3af3a3a3477"></a>
...
<a id="run-003-002-924bd122bd32"></a>
...
<a id="run-003-003-4fa00ddeda1a"></a>
...
<a id="run-003-004-cbee6fc9b855"></a>
...
<a id="run-003-005-3f40934b7a5f"></a>
