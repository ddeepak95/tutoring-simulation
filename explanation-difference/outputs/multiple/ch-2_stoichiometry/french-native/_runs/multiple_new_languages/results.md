# stoichiometry / french-native: model responses
...
- [Prompt 7 (fr)](#prompt-7)
  - [gpt-5.6-terra](#run-native_prompt-fr-fr-10921b19c733ec1a)
  - [grok-4.3](#run-native_prompt-fr-fr-50e165017cdcae7a)
  - [gemini-3.8-flash](#run-native_prompt-fr-fr-1aa3f452f546f82a)
  - [claude-sonnet-5](#run-native_prompt-fr-fr-6548dbe67f73f038)
  - [llama-4-maverick](#run-native_prompt-fr-fr-66dd96ea6d1002e8)
...
> Vous êtes un excellent professeur. Expliquez Stoechiométrie à un élève de lycée en français.

---

<a id="run-native_prompt-fr-fr-10921b19c733ec1a"></a>

### gpt-5.6-terra

**Status:** completed

**Source:** [gpt-5.6-terra__7bf477f29784.json](../../gpt-5.6-terra__7bf477f29784.json)
...
<a id="run-native_prompt-fr-fr-50e165017cdcae7a"></a>

### grok-4.3

**Status:** completed

**Source:** [grok-4.3__93b9856d5cff.json](../../grok-4.3__93b9856d5cff.json)
...
<a id="run-native_prompt-fr-fr-1aa3f452f546f82a"></a>

### gemini-3.8-flash

**Status:** completed

**Source:** [gemini-3.8-flash__f4a50cb4e33a.json](../../gemini-3.8-flash__f4a50cb4e33a.json)

Bonjour ! Installe-toi. Ne te laisse pas impressionner par ce mot barbare : **stœchiométrie** (prononce *sté-kio-mé-tri*). Ça ressemble à une formule magique dans Harry Potter, mais en réalité, c’est juste **la recette de cuisine de la chimie**.
...
<a id="run-native_prompt-fr-fr-6548dbe67f73f038"></a>

### claude-sonnet-5

**Status:** completed

**Source:** [claude-sonnet-5__4f01f0e1bb93.json](../../claude-sonnet-5__4f01f0e1bb93.json)
...
<a id="run-native_prompt-fr-fr-66dd96ea6d1002e8"></a>

### llama-4-maverick

**Status:** completed

**Source:** [llama-4-maverick__657131a3a9b9.json](../../llama-4-maverick__657131a3a9b9.json)
